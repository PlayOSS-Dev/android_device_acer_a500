...
#define LOG_TAG "Picasso PowerHAL"
#include <utils/Log.h>
...
static void picasso_power_init(struct power_module *module)
{
    /*
...
static void picasso_power_set_interactive(struct power_module *module, int on)
{
    int len;
    char buf[MAX_BUF_SZ];
...
static void picasso_power_hint(struct power_module *module, power_hint_t hint,
                            void *data)
{
    char buf[80];
    int len;
...
struct power_module HAL_MODULE_INFO_SYM = {
    .common = {
        ...
        .name = "Picasso Power HAL",
        .author = "The Android Open Source Project",
        .methods = &power_module_methods,
    },

    .init = picasso_power_init,
    .setInteractive = picasso_power_set_interactive,
    .powerHint = picasso_power_hint,
};
